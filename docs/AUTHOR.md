# Author of this encyclopedia

> **Hatnote.** This page identifies **who published the JPMI encyclopedia**. It is **not** a JPMI filesystem measurement and **not** a court finding. Custody of the Crucial X6 / E01 still runs Della Rocca → Sanders; see [People](PEOPLE.md) and [Mailing packet](MAILING_PACKET.md). Other holdings named below are **out of scope** for this repository’s analysis ([Scope](SCOPE.md)).
...
## FBI referral on 0728 (out of scope)
...
That referral is **outside this JPMI encyclopedia**. It is listed so the record shows that the author treated 0728 as a **separate** object from JPMI. Its findings are not part of the JPMI integrity article. The PDF is not in this GitHub tree.
...
Those sets are **inventory, not content**. They are not JPMI paths and are not merged into JPMI hash tables.
...
- that Marco Polo imaged the Della Rocca → Sanders Crucial X6;
- that 0728 is a laptop filesystem extract;
- any JPMI CNID, hash, or timestamp in this repo.

The essay’s political framing and Secret Service / lawsuit narrative are **outside** the JPMI question and are not part of the [Integrity](INTEGRITY.md) finding.
