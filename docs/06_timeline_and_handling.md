...
| **April 12, 2019 — location corroboration** | A later secondary-source summary of DOJ filings and forensic evidence states that FBI investigators geolocated Hunter Biden's cellphone to Wilmington's **Sikar Cigar Lounge**, near The Mac Shop, shortly before the approximately **6:50 p.m.** laptop drop-off. It says prosecutors used location logs and financial-transaction history to corroborate Mac Isaac's timeline. | This supports the chronology of the repair-shop event as an attributed public-record claim. The underlying location-log exhibit and trial transcript are not held here; the social-media image is not treated as primary evidence. See [Sikar geolocation research note](RESEARCH_SIKAR_GEOLOCATION.md). |
| **April 13, 2019**         | At Mac Isaac's request, Biden returned with an **external hard drive** for the recovered data. The court record states that Mac Isaac completed the recovery/transfer that day and called Biden. Mac Isaac later described an intermediate step in which recoverable data was first copied to his **store server** and then transferred to the customer-supplied drive. **Scatter:** Marco Polo v4 (citing Nolte) puts the WD drop and completed recovery on **17 April** instead. The Delaware opinions are the default. | The server account explains why later Mac Isaac copies need not preserve the original laptop's native disk geometry while still preserving a broad user environment. The server step is based on Mac Isaac's account, not an imaging log held here. The examined `Untitled` volume is a **26 Sep 2019 file-aware copy**, not a sector copy of the laptop partition ([COPY_METHOD](COPY_METHOD.md)).                                                                                                                 |
...
| **August 26, 2020**        | Mac Isaac emailed Robert Costello, Rudy Giuliani's attorney, saying he possessed copies of the hard drive. Court records state that Mac Isaac provided Costello a copy of the recovered data and the repair authorization. Marco Polo v4 dates the handoff **28 August 2020**. *New York* magazine (12 Sep 2022): Costello later **booted** a small external drive in Manhasset to an Apple login **“Robert Hunter”** and said the drive had been **cleaned up** before it reached him. C.D. Cal. complaint 2:23-cv-8032 (Sep 2023, later dropped): FedEx to Costello’s NY home; defendants “booted up” the drive and created “bootable copies.” **This object is BOOT01, not JPMI.** | JPMI `Untitled` has no OS and no August 2020 ColorSync. APFS and GAI inventories show ColorSync **iMac** then **two Dell** monitors and ByHost host UUIDs on **28–31 Aug 2020**. [BRANCH_DEVIATIONS](BRANCH_DEVIATIONS.md). |
...
| **October 15, 2020**       | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | JPMI shows `JPMI://Users/roberthunter/Desktop/.DS_Store` modified **one day after the New York Post story**. Finder can change `.DS_Store` simply from browsing a directory. The timing is therefore consistent with someone opening/examining the direct copy after the story broke. It is **not evidence that substantive Hunter files were injected or edited**. |
| **October 20, 2020**       | Marco Polo v4 chain-of-custody schematic: Costello/Giuliani gave a copy to **New Castle County (DE) police**. Not a JPMI acquisition fact. Raw Story (2022): **Mike Trimarco** said in Oct 2020 he had been analyzing laptop contents.                                                                                                                                                                                                                                                                                                                | Another Costello-line derivative. Todd Sanders later said his working copy came from **Trimarco** and was **not bootable until he altered it** (16 Jul 2026 chat). That is the **Costello/Trimarco** object, not the Della Rocca→Sanders JPMI stick. Marco Polo’s working machine is **MPOLO** (Hayes **bootable laptop**, Jun 2021) plus 0728 — not the JPMI reports here. |
...
| **December 12, 2020**      | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | **TRIMARCO → APFS** `HB Boot Drive` (not JPMI): volume created **12 Dec 2020**; Spotlight/CCC construction. |
| **January 5, 2021**        | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Named CCC snapshots on APFS. After this date the **TRIMARCO group** fans to **MARYMAN**, **GUSTAV**, and **TODD → HAYES** (Todd-altered copies). |
| **April 4, 2021**          | Maryman & Associates imaging of related SanDisk `20142M400253`.                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Node **MARYMAN**. TRIMARCO group, after **5 Jan 2021**. Not JPMI. |
| **May 17, 2021**           | GAI acquisition of this project’s image is **spring 2023**; the HFS+ `Biden Lap 2` **volume field** is May 2021.                                                                                                                                                                                                                                                                                                                                                                                                           | **BLAP01 / GAI**. Full OS; same Aug 2020 ICCs as APFS. Later HFS+ rebuild of the **bootable** branch, not JPMI `Untitled`. |
| **June 2, 2022**           | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | **IPHONE**: Hayes provided the iPhone-backup password. |
| **June 2021**              | Marco Polo schematic (report p. 579): Costello/Giuliani line **Jun 2021 → Marco Polo**.                                                                                                                                                                                                                                                                                                                                                                                                                                    | Node **MPOLO**: Hayes **bootable laptop** from **HAYES** (degraded; missing password vaults), not JPMI. |
| **July 28, 2021**          | Hayes MEGA share of Extra Found Files.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Node **0728**: completely separate corpus; dashed MEGA bag, not volume identity. |
| **May–June 2022**          | Dimitrelos / Washington Examiner deletion analysis **1 Jun 2022**.                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Node **GUSTAV**. TRIMARCO group, not JPMI. |
| **13 June 2022** | Hayes `RHB_Boot.imgc` image file sent over MEGA to Marc Aaron DeGiovanni (file datestamp). | Node **APFS***. When analyzed: APFS / Hayes’s APFS. Second outbound from **HAYES**. Not a USB stick. Not JPMI. |
...
- [New York magazine, Sep. 12, 2022 — Costello boots drive; login “Robert Hunter”](https://nymag.com/intelligencer/article/hunter-biden-laptop-investigation.html)
- [*Biden v. Giuliani*, C.D. Cal. 2:23-cv-8032, complaint PDF](https://storage.courtlistener.com/recap/gov.uscourts.cacd.899829/gov.uscourts.cacd.899829.1.0.pdf)
...
2. Mac Isaac staged recoverable data on his store server before transfer; the underlying server logs are not presently available here. JPMI shows the **September 2019** destination was a **new HFS+ volume** populated by a **file-aware copy** (timestamps preserved; hard-link dirs empty), later **volume-cloned** onto a Crucial X6 that did not exist until August 2020. [COPY_METHOD](COPY_METHOD.md).
...
6. Mac Isaac provided **BOOT01** (18G103 copy, created **after 26 Sep 2019**) to Robert Costello in August 2020; Giuliani later supplied material to the New York Post. **Costello never received JPMI.** Costello’s **publicly described** use is **booting** a drive to a **Robert Hunter** login (*New York*, 2022). August 2020 host/monitor fingerprints sit on **APFS and GAI**, not on JPMI. Todd Sanders later said the **Trimarco** copy had to be altered to boot; that is a **second inbound** to Todd, parallel to Della Rocca’s JPMI mailing packet. [BRANCH_DEVIATIONS](BRANCH_DEVIATIONS.md).
...
9. No hacking is attributed to JPMI. No malware or post-April bulk external-file injection has been identified in the JPMI reporting analyzed here. 0728 Extra Found Files did not come from the laptop files per se (related collection; many unknown origin). Marco Polo analyzed **MPOLO** (Hayes bootable laptop, Jun 2021), not JPMI. Dimitrelos (**GUSTAV**) and **MARYMAN** used APFS-structure copies. The author's FBI 0728 referral is outside this analysis.
