...
| **December 12, 2020**      | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | **APFS** `HB Boot Drive` (not JPMI): TRIMARCO→APFS date **unknown**; Spotlight/CCC construction; named CCC snapshots **5 Jan 2021**. After that date: **MARYMAN**, **GUSTAV**, **TODD → HAYES**. |
| **April 4, 2021**          | Maryman & Associates imaging of related SanDisk `20142M400253`.                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Node **MARYMAN**. APFS-family, after **5 Jan 2021**. Not JPMI. |
| **May 17, 2021**           | GAI acquisition of this project’s image is **spring 2023**; the HFS+ `Biden Lap 2` **volume field** is May 2021.                                                                                                                                                                                                                                                                                                                                                                                                           | GAI has a **full OS** and the **same** Aug 2020 ICCs as APFS. It is a later HFS+ rebuild of the **bootable** branch, not “pre-OS” and not JPMI `Untitled`. |
| **June 2021**              | Marco Polo schematic (report p. 579): Costello/Giuliani line **Jun 2021 → Marco Polo**.                                                                                                                                                                                                                                                                                                                                                                                                                                    | Node **MPOLO**: Hayes **bootable laptop** from **HAYES**, not JPMI. |
| **May–June 2022**          | Dimitrelos / Washington Examiner deletion analysis **1 Jun 2022**.                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Node **GUSTAV**. APFS-structure, not JPMI. |
| **June 2022 / 13 Jun 2022** | Hayes `RHB_Boot.imgc` (image-file date / MEGA) sent to Marc Aaron DeGiovanni.                                                                                                                                                                                                                                                                                                                                                                                                                                              | Node **APFS***. Second outbound from **HAYES**. Not JPMI. |
